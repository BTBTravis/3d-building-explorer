(function (global, factory) {
  ...
  */
  ...
  var assert$1 = chai$1.assert;
  var should$1 = chai$1.should();

  var spec = configs();
  console.log('spec: ', spec);
  function test$2 () {
    describe('configValidator module', function () {
      it('Min config', function () {
      ...
      it('Empty Error Message', function () {
        ...
        expect$1(res).to.have.property('errorMessages');
        assert$1.equal(res.errorMessages.includes('Config is empty object please fill it with key pairs'), true);
      });
      it('Invalid el message', function () {
        var res = configValidator(spec.invalidEl);
        expect$1(res).to.have.property('errorMessages');
        assert$1.equal(res.errorMessages.includes('invalid el in config'), true);
      });
      it('Missing key error message', function () {
